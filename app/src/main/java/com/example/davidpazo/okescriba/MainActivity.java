...
public class MainActivity extends Activity implements RecognitionListener {
    ...
    private static final String KEYPHRASE = "WOW ESCRIBA";
    ...
    private RecognitionListener reconoce;
    ...
    public void onCreate(Bundle state) {
        ...
        ((TextView) findViewById(R.id.intro_text)).setText("Preparando sintetizador");
            ...
            protected void onPostExecute(Exception result) {
                if (result != null) {
                    ((TextView) findViewById(R.id.intro_text))
                            .setText("El sintetizador fallo " + result);
                } else {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.davidpazo.okescriba/http/host/path")
        );
